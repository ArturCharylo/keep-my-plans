...
// Use fake test config for UI testing when VITE_FIREBASE_API_KEY is not a real key
const isTestEnv = import.meta.env.VITE_FIREBASE_API_KEY === 'your_api_key_here';
